...
- [ ] S3 버킷 3개 생성 완료 ([storage-guide.md](../04-storage/storage-guide.md) 참고)
- [ ] IRSA 설정 완료 ([storage-guide.md](../04-storage/storage-guide.md) 참고)
...
더 자세한 문제 해결은 [troubleshooting-guide.md](../09-operations/troubleshooting-guide.md) 참고.
