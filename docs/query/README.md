...
Grafana에서 Mimir를 Prometheus-compatible 데이터소스로 연결하고 조회하는 방법을 정리한 폴더입니다.

## 문서 목록

| 문서 | 용도 |
|------|------|
| [grafana-datasource-guide.md](grafana-datasource-guide.md) | Grafana 데이터소스, tenant header, 대시보드, 쿼리 성능 최적화 |
